const colorTileClass =
	"h-4 w-4 bigPhone:h-4 bigPhone:w-4 tablet:w-8 tablet:w-8 laptop:h-14 laptop:w-14";
         ...
         <div class="flex flex-row my-2">
          ...
          <div class="ml-2 mr-1 text-xs bigPhone:ml-4 bigPhone:mr-2 tablet:ml-10 tablet:mr-6 tablet:text-xl laptop:ml-14 laptop:mr-8 laptop:text-2xl">
            ...
            <div class="flex flex-row">
              ...
              <div style="background-color: var(--color-red);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-green);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-yellow);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-blue);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-purple);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-cyan);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-white);" class="${colorTileClass}"></div>
            </div>          
            <div class="flex flex-row">
              <div style="background-color: var(--color-brightBlack);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightRed);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightGreen);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightYellow);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightBlue);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightPurple);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightCyan);" class="${colorTileClass}"></div>
              <div style="background-color: var(--color-brightWhite);" class="${colorTileClass}"></div>
            </div>
          </div>
        </div><br>`;
